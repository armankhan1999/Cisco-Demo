...
Goal: Design a multi-level, persona-driven dashboard ecosystem for a global technology company
Key Constraint: Must use existing Claude project KPI list as foundation
Three Personas: Commercial Operations Leader, Sales Expansion Leader, Customer Success Leader
Structure Required: 3-level dashboards (Strategic → Tactical → Operational) for each persona
Deliverable: Comprehensive Dashboard Design Document

Clarifications Needed

I need to search the project knowledge base to retrieve the existing KPI list
Once retrieved, I'll derive extended KPIs and insights per persona
Output format: Structured document with tables, hierarchies, and visualization recommendations


Stage 2: Reason Step-by-Step
Plan

Search project knowledge for base KPI list
Analyze and categorize base KPIs by domain
Design common foundation (shared metrics, dimensions, governance)
Build persona-specific dashboards with 3-level hierarchy
Define data architecture and integration points
Recommend visualizations and navigation patterns
Compile final document with all sections

Execution
Let me first retrieve the base KPI list from the project knowledge:Searched project for “KPI list metrics performance indicators”9 resultsall_table_and_column_list.md6 relevant sectionstextCSM_KPI_existing.txt2 relevant sectionstextGENERATION_SUMMARY.mdtextexception_report_kpis_CSM.txttextcisco demo Action.md2 relevant sectionstextall_kpi_calculations_CMS.txttextsales expansion existing KPI's.mdtextKPI_CALCULATIONS.mdtextClean Meeting Notes.pdf2 relevant sectionsimageGood! I've retrieved extensive KPI documentation. Let me search for more specific information to ensure completeness:Searched project for “commercial operations sales expansion metrics ARR bookings”7 resultsSALES_EXPANSION_DATA_REQUIREMENTS.mdtextCOMMERCIAL_OPS_DRILL_DOWN_ARCHITECTURE.md3 relevant sectionstextKPI_CALCULATIONS.md2 relevant sectionstextcisco demo Action.md2 relevant sectionstextall_kpi_calculations_CMS.txttextClean Meeting Notes.pdftextClean Meeting Notes.pdf2 relevant sectionsimagePerfect! Now I have comprehensive information. Let me proceed with the design document.
...
ctrets this as this  in .md  file and save here in this is primary structure of my dashboards
i need this give first privority any how then others 

i need follow this main documests of dashbaords desinges